...
5. Run `make validate-agent-assets`, `make check-context-staleness`, and `make audit-module-cards`.
6. Report detected commands, generated context, validation failures, and remaining TODOs.
